			...
			<div class="divider5"></div>
				...
				<div class="row-fluid">
					<div class="span3">
						...
						<p class="help-block">NOTE: Picture  landscape with min size 442 x 479px, Larger image will be automatically cropped.</p>
					...
					<div class="span9">
						...
						<div class="row-fluid">
							<div class="span6">
								<?php $type = 'showroom_email' ?>
								<?php Common::createSetting($type, 'Showroom Email', 'text', 'n') ?>
								<label for="Setting_<?php echo $model[$type]['data']->name ?>" class="control-label required"><?php echo $model[$type]['data']->label ?><span class="required"></span></label>
								<?php echo CHtml::textField('Setting['.$model[$type]['data']->name.']', $model[$type]['data']->value, array('class'=>'span12')) ?>
							</div>
							<div class="span6">
								<?php $type = 'showroom_wa' ?>
								<?php Common::createSetting($type, 'Showroom Whatsapp', 'text', 'n') ?>
								<label for="Setting_<?php echo $model[$type]['data']->name ?>" class="control-label required"><?php echo $model[$type]['data']->label ?><span class="required"></span></label>
								<?php echo CHtml::textField('Setting['.$model[$type]['data']->name.']', $model[$type]['data']->value, array('class'=>'span12')) ?>
							</div>
						</div>

						<?php $type = 'showroom_content_btm' ?>
